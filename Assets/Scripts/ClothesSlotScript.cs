...
public class ClothesSlotScript : MonoBehaviour, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        GameManager.GetInstance().chgClothes(styleItem.spriteName);
    }

    public void SetClothesSlot(StyleItem setStyleItem)
    {
